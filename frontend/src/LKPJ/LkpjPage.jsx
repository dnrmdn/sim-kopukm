...
const api = axios.create({
  baseURL: "http://localhost:4849", // sesuaikan jika production
});
  ...
  const handleUpload = async (e) => {
    ...
    try {
      ...
      if (res.data?.success) {
        ...
        setUploadingName("");
        document.getElementById("lkpj-upload-input").value = "";
      } else {
