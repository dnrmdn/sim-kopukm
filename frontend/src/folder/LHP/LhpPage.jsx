        ...
        <header className="backdrop-blur-xl bg-slate-900/40 border-b border-white/10 sticky top-0 z-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-8 py-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-slate-400 text-sm">Laporan Hasil Pemeriksaan - Kelola dokumen dengan mudah</p>
            </div>
          </div>
        </header>
              ...
              <table className="w-full">
                ...
                <thead>
                  <tr className="bg-slate-900/60 backdrop-blur-sm border-b border-white/10">
                    <th className="px-6 py-4 text-left text-sm font-bold text-white uppercase tracking-wide">Nama Dokumen</th>
                    <th className="px-6 py-4 text-center text-sm font-bold text-white uppercase tracking-wide">Tanggal Upload</th>
                    <th className="px-6 py-4 text-center text-sm font-bold text-white uppercase tracking-wide">Aksi</th>
                  </tr>
                </thead>
