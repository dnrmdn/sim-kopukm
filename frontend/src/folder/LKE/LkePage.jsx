...
export default function SopPage() {
  ...
  const endpoints = {
    list: "/api/dokumen/lke",
    upload: "/api/dokumen/lke/upload",
    update: (id) => `/api/dokumen/lke/${id}`,
    remove: (id) => `/api/dokumen/lke/${id}`,
  };
  ...
  const fetchList = useCallback(async () => {
    try {
      ...
      setError("Gagal memuat data LKE");
    } finally {
      setLoading(false);
    }
  }, []);
  ...
  const handlePreview = (file) => {
    setPreviewFile({ name: file.name, mime: detectMime(file), url: `${api.defaults.baseURL}/api/dokumen/lke/${file.id}` });
    setPreviewOpen(true);
  };
  ...
  const handleUpload = async (e) => {
    ...
    try {
      ...
      if (res.data?.success) {
        ...
        setUploadingName("");
        const fileInput = document.getElementById("lke-upload-input");
            ...
            <div className="flex flex-col gap-6">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="space-y-2">
                  ...
                  <p className="text-gray-600 text-sm pl-1">Laporan Keuangan Eksternal — Kelola dokumen dengan mudah</p>
                </div>
              ...
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="Cari nama dokumen LKE..."
                  value={search}
          ...
          <div className="rounded-2xl border border-blue-200/70 bg-linear-to-br from-white/80 to-blue-50/80 backdrop-blur-sm shadow-xl overflow-hidden">
            ...
            <div className="p-6 sm:p-8">
              ...
              <form onSubmit={handleUpload} className="grid grid-cols-1 md:grid-cols-4 gap-3">
                ...
                <input
                  type="text"
                  placeholder="Contoh: Laporan Keuangan Eksternal 2024"
                  value={uploadingName}
          ...
          <div className="space-y-3">
            ...
            <div className="p-4 rounded-xl border border-blue-200/70 bg-linear-to-br from-white/80 to-blue-50/80 backdrop-blur-sm hover:border-blue-300 transition-all duration-200 w-fit">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-xs text-gray-600 uppercase tracking-wide">Total Dokumen LKE</p>
            ...
            {loading ? (
              <div className="flex flex-col items-center justify-center py-24">
                ...
                <p className="text-gray-600 font-medium">Memuat dokumen LKE...</p>
              </div>
              ...
              <div className="flex flex-col items-center justify-center p-12 border-2 border-dashed border-blue-300 rounded-3xl bg-linear-to-br from-blue-100/30 to-cyan-100/30">
                ...
                <p className="text-xl font-bold text-gray-800 mb-2">
                  {search ? "Tidak ada hasil pencarian" : "Belum ada dokumen LKE"}
                </p>
                <p className="text-gray-600 text-sm text-center max-w-sm">
                  {search ? "Coba ubah kata kunci pencarian" : "Upload dokumen LKE untuk memulai"}
                </p>
              </div>
            ) : (
              <>
