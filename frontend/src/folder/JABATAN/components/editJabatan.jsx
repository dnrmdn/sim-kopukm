...
const LEVEL_OPTIONS = [
  ...
  { value: "Staff / Analis / Fungsional", label: "Staff / Analis / Fungsional" },
  { value: "Driver / Security", label: "Driver / Security" },
...
export default function EditJabatan() {
  ...
  useEffect(() => {
    const fetchJabatan = async () => {
      try {
        ...
        setLevel(jabatan.level || "");
        setOriginalNama(jabatan.nama_jabatan);
        setOriginalLevel(jabatan.level || "");
      } catch (error) {
  ...
  const handleSimpan = async () => {
    ...
    if (namaJabatan === originalNama && level === originalLevel) {
  ...
  const isChanged = (namaJabatan !== originalNama || level !== originalLevel) && namaJabatan.trim() !== "" && level !== "";
                ...
                <div className="p-6 sm:p-8 space-y-6">
                    ...
                    <div className="p-4 rounded-xl bg-blue-50/80 border border-blue-200/70 space-y-3">
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-800 font-medium">{originalLevel}</p>
                        </div>
                      </div>
                    </div>
                  )}
                  ...
                  <div className="space-y-5">
                    ...
                    <div>
                      ...
                      <p className="mt-2 text-xs text-gray-500">{level ? `Level yang dipilih: ${level}` : "Belum ada level yang dipilih"}</p>
                    </div>
                  </div>
              ...
              <div className="p-4 rounded-xl border border-blue-200/70 bg-linear-to-br from-white/60 to-blue-50/60 backdrop-blur-sm flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 leading-relaxed">
                    Gunakan nama jabatan yang jelas dan deskriptif agar memudahkan identifikasi posisi dalam organisasi. Pilih level yang sesuai dengan hierarki organisasi. Anda dapat melihat nilai sebelumnya di atas.
                  </p>
                </div>
              </div>
            </div>
